...
class VerificationCodePassPage extends StatefulWidget {
  static const routeName = '/otp-password';

  const VerificationCodePassPage({super.key, required this.phoneN});
  final String phoneN;
  @override
  _VerificationCodePassPageState createState() =>
      _VerificationCodePassPageState();
}

class _VerificationCodePassPageState extends State<VerificationCodePassPage> {
  //Variables
  ...
  void verifyOtp(BuildContext context, String otp) {
    authService.PassOtp(context: context, otp: otp);
  }
